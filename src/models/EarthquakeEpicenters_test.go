...
var (
	earthquakeEpicenterDBTypes = map[string]string{`ID`: `int`, `EventID`: `bigint`, `Lat`: `double`, `Lon`: `double`, `Depth`: `int`, `EpicenterName`: `text`, `Magnitude`: `text`, `Date`: `datetime`, `Created`: `datetime`, `Row`: `text`}
	_                          = bytes.MinRead
)
